                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" value="<?php echo $category['id'] ?>" name="categories" class="custom-control-input" id="category_<?php echo $category['id'] ?>">
                                                            <label class="custom-control-label" for="category_<?php echo $category['id'] ?>"><?php echo $category['title'] ?></label>
                                                        </div>
                                            <?php
                                                    }
                                                }
                                        ...
                                        <div class="card-body">
                                            <div class="custom-control custom-checkbox">
                                                <?php
                                                    ...
                                                    ?>
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" value="<?php echo $brand['id'] ?>" name="brands" class="custom-control-input" id="brand_<?php echo $brand['id'] ?>">
                                                                <label class="custom-control-label" for="brand_<?php echo $brand['id'] ?>"><?php echo $brand['title'] ?></label>
                                                            </div>
                                                    <?php
                                                        }
                                                    }
                            ...
                            <form class="search" method="get" action="filter_price.php">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col">
                                        <div class="input-group w-100">
                                            <div class="input-field input-has-append">
                                                <input id="widget-rtlproductprice-2-widget-min" type="number" name="maxPrice" pattern="[0-9]{1,}" class="form-control" value=""data-widget="حداقل قیمت" placeholder=" مثلا: 300 هزار تومان">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="mr-4">
                                        <a href="search.php" class="btn btn-danger">حذف فیلتر ها</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row mb-3 mx-0 px-res-0">
                                <?php
                                    if (isset($_GET['minPrice'])&& $_GET['maxPrice']){
                                        $products = searchByPrice($_GET['minPrice'],$_GET['maxPrice']);
                                        if ($products){
