                    ...
                    <div class='product-carousel carousel-md owl-carousel owl-theme'>
                        <?php
                            if(isset($_GET['parent_category_id'])){
                                $categories = getCategories($_GET['parent_category_id']);
                                foreach ($categories as $category){
                                $getCategoryProducts = getCategoryProducts($category['id']);
                                if ($getCategoryProducts) {
                                        ...
                                        <div class='item'>
                                            <div class='product-card'>
                                                ...
                                                <div class='product-card-body'>
                                                    ...
                                                    <a class='product-meta' href='#'><?php echo $product['category_title'] ?></a>
                                                    <?php
                                    ...
                                    <div class="alert alert-danger">
                                        <div class="alert-text">محصولی وجود ندارد!</div>
                                    </div>
                                    <?php
                                    }
                                }
