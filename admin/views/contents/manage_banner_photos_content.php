    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <span class="text-muted font-weight-bold mr-4">در این بخش میتوانید تصاویر محصول مورد نظر را مدیریت کنید.</span>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <input id="input_banner_id" type="hidden" value="<?php echo $_GET['banner_id'] ?>">
                    <div class="dropzone dropzone-default dropzone-success" id="upload_photo_banner">
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php
                        $banner_photos = getBannerPhotos($_GET['banner_id']);
                        if ($banner_photos) {
                            foreach ($banner_photos as $photo) {
                                ?>
                                <div class="col-lg-2 text-center" id="photo<?php echo $photo['photo_id'] ?>">
                                    <div class="image-input image-input-outline">
                                        ...
                                        <button type="button" onclick="DeletePhoto(<?php echo $photo['photo_id'] ?>)" class="btn btn-hover-icon-danger" data-toggle="tooltip"><i class="fa fa-trash"></i></button>
