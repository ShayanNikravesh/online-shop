        ...
        <div class="container">
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="dropzone dropzone-default dropzone-success" id="upload_photo_products">
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php
                        $product_photos = getProductPhotos($_GET['product_id']);
                        if ($product_photos) {
                            foreach ($product_photos as $photo) {
                                ?>
                                <div class="col-lg-2 text-center" id="photo<?php echo $photo['photo_id'] ?>">
                                    <label for="">تصویر «<?php echo $photo['sort'] ?>»</label>
