                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-item">
                            ...
                            ?>
                            <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" style="background-color: #0c0e18" id="kt_quick_user_toggle">
                                <span class="text-white font-weight-bolder font-size-base d-none d-md-inline "><?php echo $manager['first_name'] ?></span>
                                <!--<span class="symbol symbol-lg-35 symbol-25 symbol-light-success"><span class="symbol-label font-size-h5 font-weight-bold"></span></span>-->
                            </div>
                        </div>
                        <!--end::User-->
                    </div>
